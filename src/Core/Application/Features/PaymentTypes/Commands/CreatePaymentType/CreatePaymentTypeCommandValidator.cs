...
namespace Application.Features.PaymentTypes.Commands.CreatePaymentType
{
    public class CreatePaymentTypeCommandValidator : AbstractValidator<CreatePaymentTypeCommand>
    {
        ...
        public CreatePaymentTypeCommandValidator(IRepositoryWrapper repository, IMapper mapper)
        {
        ...
        private async Task<bool> IsUnique(CreatePaymentTypeCommand paymentTypeCommand, CancellationToken cancellationToken)
        {
