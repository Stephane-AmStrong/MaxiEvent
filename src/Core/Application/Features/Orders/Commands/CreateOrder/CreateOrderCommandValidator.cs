...
namespace Application.Features.Orders.Commands.CreateOrder
{
    public class CreateOrderCommandValidator : AbstractValidator<CreateOrderCommand>
    {
        ...
        public CreateOrderCommandValidator(IRepositoryWrapper repository, IMapper mapper)
        {
        ...
        private async Task<bool> IsUnique(CreateOrderCommand orderCommand, CancellationToken cancellationToken)
        {
