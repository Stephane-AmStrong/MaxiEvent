...
namespace Application.Features.Workstations.Commands.UpdateWorkstation
{
    public class UpdateWorkstationCommandValidator : AbstractValidator<UpdateWorkstationCommand>
    {
        ...
        public UpdateWorkstationCommandValidator(IRepositoryWrapper repository, IMapper mapper)
        {
        ...
        private async Task<bool> IsUnique(UpdateWorkstationCommand workstationCommand, CancellationToken cancellationToken)
        {
